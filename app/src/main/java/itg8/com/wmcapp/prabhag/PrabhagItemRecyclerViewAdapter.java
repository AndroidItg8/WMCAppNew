...
public class PrabhagItemRecyclerViewAdapter extends RecyclerView.Adapter<PrabhagItemRecyclerViewAdapter.ViewHolder> {
    ...
    private final PrabhagFragment.OnListFragmentInteractionListener mListener;

    public PrabhagItemRecyclerViewAdapter(List<DummyContent.DummyItem> items, PrabhagFragment.OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
